      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2"><a href="#">DiSKO</a></h2>
            <p><a href="#">Semua Produk Makanan Kami Halal</a></p>
            <ul class="ftco-footer-social list-unstyled float-md-center float-lft mt-5" >
              ...
              <li class="ftco-animate"><a href="https://api.whatsapp.com/send?phone=+6281382055381&text=saya ingin melakukan pembelian mobil." target='_BLANK'><span
			        ...
			        <li class="ftco-animate"><a href="https://m.facebook.com/ad.roin.58muham" target='_BLANK'><span class="icon-facebook" ></span></a></li>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span>Cikampek<span class="text"></span></li>
                  <li><a href="#"><span class="icon icon-phone"></span>087796902245<span class="text"></span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span>disko01@gmail.com<span class="text"></span></a></li>
                </ul>
              </div>
          </div>
        </div>
